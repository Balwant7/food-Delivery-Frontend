...
const Navbar = () => {
  return (
    <div
      id="Navbar"
      className="flex items-center justify-between w-[80%] py-10 m-auto"
    >
      ...
      <div id="navbar-right" className="flex gap-10 items-center">
        ...
        <button className="rounded-full border border-orange-600 px-6 py-2 hover:bg-orange-100 duration-300 transition-all">
          Sign in
        </button>
      </div>
    </div>
